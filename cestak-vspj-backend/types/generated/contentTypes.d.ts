...
export interface ApiPoptavkaPoptavka extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    PocetOsob: Schema.Attribute.Integer & Schema.Attribute.Required;
    CeleJmeno: Schema.Attribute.String & Schema.Attribute.Required;
    Bydliste: Schema.Attribute.String & Schema.Attribute.Required;
    Telefon: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    Email: Schema.Attribute.Email;
    DatumNarozeni: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiUvodniObrazkyUvodniObrazky
  extends Struct.CollectionTypeSchema {
  collectionName: 'uvodni_obrazkies';
  info: {
    singularName: 'uvodni-obrazky';
    pluralName: 'uvodni-obrazkies';
    displayName: 'UvodniObrazky';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    Obrazky: Schema.Attribute.Media<'images', true> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::uvodni-obrazky.uvodni-obrazky'
    >;
  };
}

export interface ApiZajezdZajezd extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DodatekNazvu: Schema.Attribute.String;
    Cena: Schema.Attribute.Integer & Schema.Attribute.Required;
    Od: Schema.Attribute.Date & Schema.Attribute.Required;
    Do: Schema.Attribute.Date & Schema.Attribute.Required;
    Strava: Schema.Attribute.Enumeration<
      ['Pln\u00E1 penze', 'Polopenze', 'Bez stravy']
    > &
      Schema.Attribute.Required;
    Program: Schema.Attribute.RichText & Schema.Attribute.Required;
    Tipy: Schema.Attribute.Component<'tip.tip', true>;
    Poznamky: Schema.Attribute.RichText;
    Obrazky: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    Detail: Schema.Attribute.Component<'detail.program-detaily', true>;
    InformaceDopravy: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::zajezd.zajezd'>;
  };
}

export interface ApiZpravaOdUzivateleZpravaOdUzivatele
  extends Struct.CollectionTypeSchema {
  collectionName: 'zprava_od_uzivateles';
  info: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::zprava-od-uzivatele.zprava-od-uzivatele'
    >;
  };
}
